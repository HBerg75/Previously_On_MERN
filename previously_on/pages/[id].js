...
//     if (x.className === "jsx-1382363189 none") {
//         x.className = "jsx-1382363189 display";
//     } else {
//         x.className = "jsx-1382363189 none";
//     }
//     console.log(x);
...
function Post({ post, saisons, episodes }) {
    ...
    if (episodes.episodes[0].user.seen == false) {
        var vu = "non";
    } else {
        var vu = "oui";
    }
                    ...
                    <div className="episodes_details">
                        {episodes.episodes.map((episode, i) => {
                            return (
                                <>
                                    <div key={i}>
                                        <button>{episode.code}</button>
                                        <button> Marqué comme vu</button>
                                    </div>

                                    <div className="display" id={episode.id}>
                                        Vu : {vu} <br />
